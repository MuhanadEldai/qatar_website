...
function submitBooking() {
    ...
    const location = form.querySelector('input[placeholder*="hotel"], input[placeholder*="Hotel"]').value;
    ...
    // Format WhatsApp Message - SIMPLIFIED
    const message = `📋 NEW BOOKING REQUEST\n\n` +
        `👤 Name: ${name}\n` +
        `📞 Phone: ${phone}\n` +
        `📧 Email: ${email}\n` +
        `📅 Date: ${date}\n` +
        `⏰ Time: ${timeLabel} (${timeRange})\n` +
        `📍 Pickup: ${location}\n` +
        `👥 Adults: ${adults}\n` +
        `👶 Children: ${children}\n` +
