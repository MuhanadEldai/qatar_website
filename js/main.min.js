...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const galleryItems = [
        { title: 'Falconry Experience', desc: 'Traditional Qatari culture', img: 'images/tour-photos/falcon-photo.jpg' },
        { title: 'Desert Legend', desc: 'Our Land Cruiser fleet', img: 'images/tour-photos/land-cruiser.jpg' },
        { title: 'Group Safari', desc: 'Unforgettable memories', img: 'images/tour-photos/group-photo.jpg' },
        { title: 'Inland Sea', desc: 'Where desert meets the ocean', img: 'images/tour-photos/inland-sea.jpg' },
        { title: 'Sand Boarding', desc: 'Thrills on the dunes', img: 'images/tour-photos/sand-boarding.jpg' },
        { title: 'Sunset Magic', desc: 'Golden hour in the desert', img: 'images/tour-photos/sunset-view.jpg' }
    ];
